...
export default {
  ...
  "session.reasoning_only_hint": "This model returned thinking only. Turn on Thinking to see details.",
  "session.thinking_live_badge": "Thinking",
  "session.thinking_last_badge": "Last Thinking",
  "session.thinking_snapshot_hint": "This is the last thinking update captured before the run completed.",
  "session.engine_required_title": "Agent mode needs an OpenCode engine",
  "session.engine_required_description": "OpenCode is not connected. Start opencode serve first, or switch to Studio for direct chat/image.",
  "session.open_studio_mode": "Open Studio",
  "session.open": "Open",
  ...
  "skills.access.web_local_limited": "Web-only mode: you can view skills, but import/install requires desktop mode or a writable OpenWork server.",
  "skills.access.remote_disconnected": "OpenWork server is disconnected. Connect in Settings before managing skills.",
  "skills.access.remote_token_required": "OpenWork server token is missing. Add a token to manage skills.",
  "skills.access.remote_readonly": "OpenWork server is read-only for skills.",
  "skills.plugins_access.remote_disconnected": "OpenWork server is disconnected. Plugins are read-only.",
  "skills.plugins_access.remote_token_required": "OpenWork server token is missing. Plugin edits are disabled.",
  "skills.plugins_access.remote_readonly": "OpenWork server is read-only for plugins.",
  ...
  "settings.updater.auto_checks": "Automatic checks",
  "settings.updater.auto_checks_hint": "Once per day (quiet)",
  "settings.updater.toolbar_available": "Desktop update available {version}",
  "settings.updater.toolbar_ready": "Desktop update {version} is ready to install",
  "settings.updater.toolbar_downloading": "Downloading update {progress}",
  "settings.updater.toolbar_checking": "Checking for updates",
  "settings.updater.toolbar_error": "Update check failed",
  "settings.updater.toolbar_idle": "Up to date",
  "settings.updater.toolbar_description": "This updates the OpenWork desktop app and restarts it automatically.",
  "settings.updater.action_download": "Download update",
  "settings.updater.action_install_restart": "Install & restart",
  "settings.updater.action_retry": "Retry",
  "settings.updater.action_check": "Check",
  "settings.updater.stop_runs_to_update": "Stop active runs before updating",
  "settings.updater.last_checked": "Last checked: {time}",
  "settings.updater.published_at": "Published: {date}",
  ...
  // ==================== First Run Setup ====================
  "setup.title": "First-run quick setup",
  "setup.subtitle": "Set up a workspace and provider key so the app is usable immediately.",
  "setup.skip": "Skip for now",
  "setup.step_workspace_title": "Step 1: create a workspace",
  "setup.step_workspace_desc": "Workspaces hold sessions, skills, plugins, and project context.",
  "setup.create_workspace": "Create local workspace",
  "setup.add_remote_workspace": "Connect remote workspace",
  "setup.step_provider_title": "Step 2: configure provider key",
  "setup.step_provider_desc": "Test connectivity before saving the API key.",
  "setup.no_provider_option": "No providers available",
  "setup.api_key_placeholder": "Paste API key (stored locally only)",
  "setup.testing": "Testing...",
  "setup.test_and_save": "Test and save",
  "setup.provider_base_url": "Base URL:",
  "setup.open_provider_settings": "Open full provider settings",
  "setup.incomplete_hint": "Finish both steps to start a session safely.",
  "setup.complete_hint": "Setup complete. You can start using OpenWork now.",
  "setup.open_studio": "Open Studio",
  "setup.start_session": "Start session",
  "setup.error_provider_required": "Select a provider first.",
  "setup.error_api_key_required": "Enter an API key first.",
  "setup.provider_test_ok": "Connection test passed",
  "setup.provider_saved": "Saved locally",
  "setup.provider_save_failed": "Failed to save provider settings",
  ...
  "dashboard.add_workspace": "Add a workspace",
  ...
  // ==================== Cowork Providers ====================
  "cowork.providers.title": "OpenAI-compatible providers",
  "cowork.providers.subtitle": "Configure multiple model endpoints and keep API keys local to your machine.",
  "cowork.providers.refresh": "Refresh",
  "cowork.providers.snippet": "opencode.json snippet",
  "cowork.providers.storage_label": "Storage:",
  "cowork.providers.storage_server": "OpenWork host (~/.config/my-first-cowork)",
  "cowork.providers.storage_local": "Browser local storage",
  "cowork.providers.loading": "Loading providers…",
  "cowork.providers.defaults_title": "Defaults",
  "cowork.providers.chat_model": "Chat model",
  "cowork.providers.vision_model": "Vision model",
  "cowork.providers.image_model": "Image model",
  "cowork.providers.select_provider": "Select provider",
  "cowork.providers.select_model": "Select model",
  "cowork.providers.save_defaults": "Save defaults",
  "cowork.providers.saving": "Saving...",
  "cowork.providers.edit_provider": "Edit provider",
  "cowork.providers.add_provider": "Add provider",
  "cowork.providers.new_provider": "New provider",
  "cowork.providers.provider_id": "Provider id",
  "cowork.providers.provider_name": "Name",
  "cowork.providers.base_url": "Base URL",
  "cowork.providers.api_key": "API key",
  "cowork.providers.hide_key": "Hide",
  "cowork.providers.show_key": "Show",
  "cowork.providers.key_saved": "Key saved",
  "cowork.providers.clear_key": "Clear key",
  "cowork.providers.model_catalog": "Model catalog (one per line)",
  "cowork.providers.default_chat": "Default chat model",
  "cowork.providers.default_vision": "Default vision model",
  "cowork.providers.default_image": "Default image model",
  "cowork.providers.save_provider": "Save provider",
  "cowork.providers.add_provider_action": "Add provider",
  "cowork.providers.test_connection": "Test connection",
  "cowork.providers.testing": "Testing...",
  "cowork.providers.test_requires_key": "Base URL and API key are required to test.",
  "cowork.providers.connection_failed": "Connection failed",
  "cowork.providers.id_required": "Provider id is required.",
  "cowork.providers.base_url_required": "Base URL is required.",
  "cowork.providers.models_required": "Add at least one model.",
  "cowork.providers.saved": "Provider saved.",
  "cowork.providers.save_failed": "Failed to save provider.",
  "cowork.providers.cors_hint": "Browser blocked by CORS. Use headless web or the desktop app to test.",
  "cowork.providers.configured": "Configured providers",
  "cowork.providers.none": "No providers yet.",
  "cowork.providers.edit": "Edit",
  "cowork.providers.deleting": "Deleting",
  "cowork.providers.delete": "Delete",
  "cowork.providers.models_count": "{count} models",
  "cowork.providers.api_key_saved": "API key saved",
  "cowork.providers.snippet_title": "opencode.json snippet",
  "cowork.providers.close": "Close",
  "cowork.providers.snippet_include_keys": "Include API keys in snippet",
  "cowork.providers.copied": "Copied",
  "cowork.providers.copy": "Copy",

  // ==================== Studio ====================
  "studio.direct_title": "Direct chat",
  "studio.direct_subtitle": "Use OpenAI-compatible endpoints directly.",
  "studio.clear": "Clear",
  "studio.no_providers": "No providers configured. Add one in Settings → Providers.",
  "studio.quick_start": "Start a quick conversation. Supports images and reasoning.",
  "studio.role_user": "You",
  "studio.role_assistant": "Assistant",
  "studio.thinking_show": "Show reasoning",
  "studio.thinking_hide": "Hide reasoning",
  "studio.provider_storage": "Provider storage:",
  "studio.storage_host": "host",
  "studio.storage_browser": "browser",
  "studio.prompt_placeholder": "Ask anything...",
  "studio.add_image": "Add image",
  "studio.attachments_count": "{count} attached",
  "studio.send": "Send",
  "studio.sending": "Sending...",
  "studio.error_pick_provider": "Pick a provider first.",
  "studio.error_missing_key": "API key missing for selected provider.",
  "studio.error_pick_model": "Select a model for chat.",
  "studio.error_chat_failed": "Chat failed",
  "studio.empty_response": "Model returned no visible output.",
  "studio.cors_error": "Browser blocked by CORS. Start headless web or the desktop app to use providers.",
  "studio.image_title": "Image studio",
  "studio.image_subtitle": "Generate images with your OpenAI-compatible providers.",
  "studio.no_image_providers": "No image providers configured yet.",
  "studio.image_prompt_placeholder": "Describe the image you want…",
  "studio.generate": "Generate",
  "studio.generating": "Generating...",
  "studio.error_image_failed": "Image generation failed",
  "studio.error_image_model_unsupported": "Selected model does not support image generation. Switch to an image model and retry.",
  "studio.error_provider_image_failed": "Image request failed: {detail}",
  "studio.error_provider_auth_failed": "Provider authentication failed. Check API key or reconnect provider.",
  "studio.image_empty": "Generated images will appear here.",
  "studio.insert_into_chat": "Insert into chat",
  "studio.templates_title": "Frontend workflow templates",
  "studio.error_pick_image_provider": "Pick an image provider first.",
  "studio.template.react_storybook": "Turn this requirement into a React component + Storybook",
  "studio.template.tailwind_from_design": "Create a Tailwind layout from a design/screenshot",
  "studio.template.fix_ts": "Fix TS errors and explain the cause (minimal changes)",
  "studio.template.extract_hooks": "Split a page into components and extract hooks",
  "studio.template.performance_audit": "Performance audit: find bundle and render bottlenecks",
  ...
  "scheduled.empty": "No automations yet. Pick a template or create your own automation prompt.",
  "scheduled.unavailable": "Unavailable",
  "scheduled.never": "Never",
  "scheduled.default": "Default",
  "scheduled.cron": "Cron",
  "scheduled.run_context": "Run context",
  "scheduled.source.label": "Source:",
  ...
  "scheduled.summary.missing": "No prompt or command found.",
  ...
  "scheduled.support.desktop_only": "Scheduled tasks require the desktop app.",
  ...
  "scheduled.scheduler.remote": "OpenWork server",
  "scheduled.scheduler.local": "Local",
  ...
  "scheduled.delete.title": "Delete automation?",
  "scheduled.delete.button": "Delete",
  "scheduled.delete.deleting": "Deleting",
  ...
  "scheduled.last_sync.never": "Not synced yet",
  "scheduled.stats.automations": "Automations",
  "scheduled.stats.active": "Active automations",
  "scheduled.stats.last_sync": "Last sync",
  "scheduled.stats.scheduler": "Scheduler",
  "scheduled.create.title": "Create automation",
  "scheduled.create.hint": "Automations are scheduled by running a prompt in a new thread. We’ll prefill a prompt for you to send.",
  "scheduled.create.name": "Name",
  "scheduled.create.project": "Project",
  "scheduled.create.choose_folder": "Choose a folder",
  "scheduled.create.prompt": "Prompt",
  "scheduled.create.schedule": "Schedule",
  "scheduled.create.daily": "Daily",
  "scheduled.create.interval": "Interval",
  "scheduled.create.every": "Every",
  "scheduled.create.hours": "hours",
  "scheduled.create.cron": "Cron:",
  "scheduled.create.view_docs": "View scheduler docs",
  "scheduled.create.create": "Create",
  "scheduled.create.default_name": "Daily bug scan",
  "scheduled.create.default_prompt": "Scan recent commits and flag riskier diffs.",
  "scheduled.days.mo": "Mo",
  "scheduled.days.tu": "Tu",
  "scheduled.days.we": "We",
  "scheduled.days.th": "Th",
  "scheduled.days.fr": "Fr",
  "scheduled.days.sa": "Sa",
  "scheduled.days.su": "Su",
  "scheduled.templates.risky_diffs.description": "Scan recent commits and flag riskier diffs.",
  "scheduled.templates.risky_diffs.prompt": "Schedule a daily job at 9am to scan recent commits and flag riskier diffs.",
  "scheduled.templates.release_notes.description": "Draft weekly release notes from merged PRs.",
  "scheduled.templates.release_notes.prompt": "Schedule a weekly job on Fridays at 4pm to draft release notes from merged PRs.",
  "scheduled.templates.git_summary.description": "Summarize yesterday's git activity by repo.",
  "scheduled.templates.git_summary.prompt": "Schedule a daily job at 6pm to summarize yesterday's git activity by repo.",
  "scheduled.templates.ci_flakes.description": "Watch CI failures and surface recurring flakes.",
  "scheduled.templates.ci_flakes.prompt": "Schedule a job every 6 hours to summarize CI failures and surface recurring flakes.",
  "scheduled.templates.team_demo_game.description": "Build a tiny classic game for a team demo.",
  "scheduled.templates.team_demo_game.prompt": "Schedule a weekly job on Mondays at 10am to build a tiny classic game for a team demo.",
  "scheduled.templates.next_skills.description": "Suggest the next skills to install for this workspace.",
  "scheduled.templates.next_skills.prompt": "Schedule a weekly job on Wednesdays at 2pm to suggest the next skills to install for this workspace.",

  // ==================== Settings (Extras) ====================
  "settings.tab.general": "General",
  "settings.tab.model": "Model",
  "settings.tab.messaging": "Messaging Bridge",
  ...
  "settings.startup.local": "Start local server",
  "settings.startup.server": "Connect to server",
  "settings.startup.not_set": "Not set",
