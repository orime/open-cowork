...
export default {
  ...
  "session.reasoning_only_hint": "该模型只返回了 thinking 内容，请开启 Thinking 查看详情。",
  "session.thinking_live_badge": "Thinking",
  "session.thinking_last_badge": "最近 Thinking",
  "session.thinking_snapshot_hint": "以上是本轮任务结束前捕获的最后一条 thinking。",
  "session.engine_required_title": "Agent 模式依赖 OpenCode 引擎",
  "session.engine_required_description": "当前未连接 OpenCode。你可以先启动 opencode serve，或切到 Studio 先做直连对话/生图。",
  "session.open_studio_mode": "打开 Studio",
  "session.open": "打开",
  ...
  "skills.new_skill": "新建 Skill",
  "skills.learn_more": "了解更多",
  "skills.run": "运行",
  ...
  "skills.access.web_local_limited": "当前是纯 Web 模式：可查看 skills，但导入/安装需要桌面端或已连接可写的 OpenWork server。",
  "skills.access.remote_disconnected": "OpenWork server 未连接。先在设置页连接后再管理 skills。",
  "skills.access.remote_token_required": "OpenWork server 缺少 token。补充 token 后才能管理 skills。",
  "skills.access.remote_readonly": "OpenWork server 当前是只读模式，无法修改 skills。",
  "skills.plugins_access.remote_disconnected": "OpenWork server 未连接。插件当前只读。",
  "skills.plugins_access.remote_token_required": "OpenWork server 缺少 token，暂时无法修改插件。",
  "skills.plugins_access.remote_readonly": "OpenWork server 当前是只读模式，无法修改插件。",
  "skills.uninstall": "卸载",
  ...
  "settings.updater.auto_checks": "自动检查",
  "settings.updater.auto_checks_hint": "每天一次（静默）",
  "settings.updater.toolbar_available": "检测到桌面端新版本 {version}",
  "settings.updater.toolbar_ready": "桌面端新版本 {version} 已下载，可安装",
  "settings.updater.toolbar_downloading": "正在下载更新 {progress}",
  "settings.updater.toolbar_checking": "正在检查更新",
  "settings.updater.toolbar_error": "更新检查失败",
  "settings.updater.toolbar_idle": "当前已是最新版本",
  "settings.updater.toolbar_description": "将更新 OpenWork 桌面应用并自动重启。",
  "settings.updater.action_download": "下载更新",
  "settings.updater.action_install_restart": "安装并重启",
  "settings.updater.action_retry": "重试",
  "settings.updater.action_check": "检查更新",
  "settings.updater.stop_runs_to_update": "停止活动运行后才能更新",
  "settings.updater.last_checked": "上次检查：{time}",
  "settings.updater.published_at": "发布时间：{date}",
  ...
  // ==================== First Run Setup ====================
  "setup.title": "首次使用快速设置",
  "setup.subtitle": "先完成工作区和模型 Provider 配置，马上可用。",
  "setup.skip": "稍后再说",
  "setup.step_workspace_title": "步骤 1：创建工作区",
  "setup.step_workspace_desc": "工作区用于管理你的会话、skills、插件和项目上下文。",
  "setup.create_workspace": "创建本地工作区",
  "setup.add_remote_workspace": "连接远程工作区",
  "setup.step_provider_title": "步骤 2：配置 Provider Key",
  "setup.step_provider_desc": "先测通再保存 API key，避免后续发送消息无响应。",
  "setup.no_provider_option": "暂无可用 Provider",
  "setup.api_key_placeholder": "粘贴 API key（仅保存在本机）",
  "setup.testing": "测试中...",
  "setup.test_and_save": "测试并保存",
  "setup.provider_base_url": "Base URL：",
  "setup.open_provider_settings": "打开完整 Provider 设置",
  "setup.incomplete_hint": "完成以上两步后，可直接开始会话。",
  "setup.complete_hint": "配置已完成，可直接开始使用。",
  "setup.open_studio": "打开 Studio",
  "setup.start_session": "开始会话",
  "setup.error_provider_required": "请先选择 Provider。",
  "setup.error_api_key_required": "请先输入 API key。",
  "setup.provider_test_ok": "连接测试通过",
  "setup.provider_saved": "已保存到本机",
  "setup.provider_save_failed": "保存 Provider 配置失败",
  ...
  "dashboard.studio": "工作室",
  "dashboard.apps": "应用",
  "dashboard.new_session": "新建会话",
  "dashboard.add_workspace": "添加工作区",

  // ==================== Settings (Extras) ====================
  "settings.providers_tab": "模型供应商",
  "settings.providers_title": "模型供应商",

  // ==================== Cowork Providers ====================
  "cowork.providers.title": "OpenAI-compatible 供应商",
  "cowork.providers.subtitle": "配置多个模型接口，并把 API key 保存在本机。",
  "cowork.providers.refresh": "刷新",
  "cowork.providers.snippet": "opencode.json 片段",
  "cowork.providers.storage_label": "存储位置：",
  "cowork.providers.storage_server": "OpenWork 主机（~/.config/my-first-cowork）",
  "cowork.providers.storage_local": "浏览器本地存储",
  "cowork.providers.loading": "正在加载供应商…",
  "cowork.providers.defaults_title": "默认值",
  "cowork.providers.chat_model": "聊天模型",
  "cowork.providers.vision_model": "视觉模型",
  "cowork.providers.image_model": "生图模型",
  "cowork.providers.select_provider": "选择供应商",
  "cowork.providers.select_model": "选择模型",
  "cowork.providers.save_defaults": "保存默认",
  "cowork.providers.saving": "保存中...",
  "cowork.providers.edit_provider": "编辑供应商",
  "cowork.providers.add_provider": "新增供应商",
  "cowork.providers.new_provider": "新供应商",
  "cowork.providers.provider_id": "供应商 ID",
  "cowork.providers.provider_name": "名称",
  "cowork.providers.base_url": "Base URL",
  "cowork.providers.api_key": "API key",
  "cowork.providers.hide_key": "隐藏",
  "cowork.providers.show_key": "显示",
  "cowork.providers.key_saved": "已保存 key",
  "cowork.providers.clear_key": "清除 key",
  "cowork.providers.model_catalog": "模型列表（每行一个）",
  "cowork.providers.default_chat": "默认聊天模型",
  "cowork.providers.default_vision": "默认视觉模型",
  "cowork.providers.default_image": "默认生图模型",
  "cowork.providers.save_provider": "保存供应商",
  "cowork.providers.add_provider_action": "新增供应商",
  "cowork.providers.test_connection": "测试连接",
  "cowork.providers.testing": "测试中...",
  "cowork.providers.test_requires_key": "测试需要 Base URL 和 API key。",
  "cowork.providers.connection_failed": "连接失败",
  "cowork.providers.id_required": "请填写供应商 ID。",
  "cowork.providers.base_url_required": "请填写 Base URL。",
  "cowork.providers.models_required": "请至少填写一个模型。",
  "cowork.providers.saved": "供应商已保存。",
  "cowork.providers.save_failed": "保存供应商失败。",
  "cowork.providers.cors_hint": "浏览器被 CORS 拦截。请使用 headless web 或桌面端测试。",
  "cowork.providers.configured": "已配置的供应商",
  "cowork.providers.none": "还没有供应商。",
  "cowork.providers.edit": "编辑",
  "cowork.providers.deleting": "删除中",
  "cowork.providers.delete": "删除",
  "cowork.providers.models_count": "{count} 个模型",
  "cowork.providers.api_key_saved": "已保存 API key",
  "cowork.providers.snippet_title": "opencode.json 片段",
  "cowork.providers.close": "关闭",
  "cowork.providers.snippet_include_keys": "片段中包含 API key",
  "cowork.providers.copied": "已复制",
  "cowork.providers.copy": "复制",

  // ==================== Studio ====================
  "studio.direct_title": "直连对话",
  "studio.direct_subtitle": "直接使用 OpenAI-compatible 接口。",
  "studio.clear": "清空",
  "studio.no_providers": "还没有配置供应商。请到 设置 → Providers 添加。",
  "studio.quick_start": "开始一段快速对话。支持图片与 reasoning。",
  "studio.role_user": "你",
  "studio.role_assistant": "助手",
  "studio.thinking_show": "显示 reasoning",
  "studio.thinking_hide": "隐藏 reasoning",
  "studio.provider_storage": "供应商存储：",
  "studio.storage_host": "主机",
  "studio.storage_browser": "浏览器",
  "studio.prompt_placeholder": "随便问点什么...",
  "studio.add_image": "添加图片",
  "studio.attachments_count": "已附加 {count} 个",
  "studio.send": "发送",
  "studio.sending": "发送中...",
  "studio.error_pick_provider": "先选择一个供应商。",
  "studio.error_missing_key": "当前供应商缺少 API key。",
  "studio.error_pick_model": "请选择聊天模型。",
  "studio.error_chat_failed": "对话失败",
  "studio.empty_response": "模型未返回可显示内容。",
  "studio.cors_error": "浏览器被 CORS 拦截。请使用 headless web 或桌面端。",
  "studio.image_title": "生图工作室",
  "studio.image_subtitle": "用你的 OpenAI-compatible 供应商生成图片。",
  "studio.no_image_providers": "还没有配置生图供应商。",
  "studio.image_prompt_placeholder": "描述你想要的画面…",
  "studio.generate": "生成",
  "studio.generating": "生成中...",
  "studio.error_image_failed": "生成图片失败",
  "studio.error_image_model_unsupported": "当前所选模型不支持生图，请切换到图片模型后重试。",
  "studio.error_provider_image_failed": "生图请求失败：{detail}",
  "studio.error_provider_auth_failed": "当前供应商认证失败，请检查 API key 或重新连接。",
  "studio.image_empty": "生成的图片会显示在这里。",
  "studio.insert_into_chat": "插入对话",
  "studio.templates_title": "前端工作流模板",
  "studio.error_pick_image_provider": "先选择一个生图供应商。",
  "studio.template.react_storybook": "把这个需求变成 React 组件 + Storybook",
  "studio.template.tailwind_from_design": "根据设计稿/截图生成 Tailwind 布局",
  "studio.template.fix_ts": "修 TS 报错并解释原因（最小改动）",
  "studio.template.extract_hooks": "从一个页面拆成组件并提取 hooks",
  "studio.template.performance_audit": "性能诊断：找 bundle 体积与渲染瓶颈",
  ...
  "scheduled.empty": "还没有自动化。选择一个模板或创建你自己的自动化提示词。",
  "scheduled.unavailable": "不可用",
  "scheduled.never": "从未",
  "scheduled.default": "默认",
  "scheduled.cron": "Cron",
  "scheduled.run_context": "运行上下文",
  "scheduled.source.label": "来源：",
  ...
  "scheduled.summary.missing": "未找到提示词或命令。",
  "scheduled.status.not_run": "尚未运行",
  "scheduled.status.running": "运行中",
  "scheduled.status.success": "成功",
  "scheduled.status.failed": "失败",
  "scheduled.support.remote_unavailable": "OpenWork 服务器不可用。连接后可同步自动化任务。",
  "scheduled.support.desktop_only": "定时任务需要桌面端应用。",
  "scheduled.support.windows_unsupported": "Windows 暂不支持调度器。",
  "scheduled.source.remote_description": "从已连接的 OpenWork 服务器按计划运行的自动化。",
  "scheduled.source.local_description": "从本机按计划运行的自动化。",
  "scheduled.source.remote_label": "来自 OpenWork 服务器",
  "scheduled.source.local_label": "来自本机调度器",
  "scheduled.scheduler.remote": "OpenWork 服务器",
  "scheduled.scheduler.local": "本机",
  ...
  "scheduled.scheduler.desktop_only": "仅桌面端",
  "scheduled.delete.title": "删除自动化？",
  "scheduled.delete.button": "删除",
  "scheduled.delete.deleting": "删除中...",
  "scheduled.delete.remote_description": "这会移除计划并从已连接的 OpenWork 服务器删除该任务定义。",
  "scheduled.delete.local_description": "这会移除计划并从本机删除该任务定义。",
  "scheduled.last_sync.never": "尚未同步",
  "scheduled.stats.automations": "自动化",
  "scheduled.stats.active": "活跃自动化",
  "scheduled.stats.last_sync": "上次同步",
  "scheduled.stats.scheduler": "调度器",
  "scheduled.create.title": "创建自动化",
  "scheduled.create.hint": "自动化通过在新会话中运行一段提示词来创建。我们会为你预填一段可直接发送的提示词。",
  "scheduled.create.name": "名称",
  "scheduled.create.project": "项目",
  "scheduled.create.choose_folder": "选择文件夹",
  "scheduled.create.prompt": "提示词",
  "scheduled.create.schedule": "计划",
  "scheduled.create.daily": "每天",
  "scheduled.create.interval": "间隔",
  "scheduled.create.every": "每",
  "scheduled.create.hours": "小时",
  "scheduled.create.cron": "Cron：",
  "scheduled.create.view_docs": "查看调度器文档",
  "scheduled.create.create": "创建",
  "scheduled.create.default_name": "每日风险扫描",
  "scheduled.create.default_prompt": "扫描最近提交并标记风险较高的变更。",
  "scheduled.days.mo": "一",
  "scheduled.days.tu": "二",
  "scheduled.days.we": "三",
  "scheduled.days.th": "四",
  ...
  "scheduled.days.sa": "六",
  "scheduled.days.su": "日",
  "scheduled.templates.risky_diffs.description": "扫描最近提交并标记风险较高的变更。",
  "scheduled.templates.risky_diffs.prompt": "创建一个每天早上 9 点运行的任务：扫描最近提交并标记风险较高的变更。",
  "scheduled.templates.release_notes.description": "从已合并的 PR 起草每周发布说明。",
  "scheduled.templates.release_notes.prompt": "创建一个每周五下午 4 点运行的任务：从已合并的 PR 起草发布说明。",
  "scheduled.templates.git_summary.description": "按仓库汇总昨天的 Git 活动。",
  "scheduled.templates.git_summary.prompt": "创建一个每天晚上 6 点运行的任务：按仓库汇总昨天的 Git 活动。",
  "scheduled.templates.ci_flakes.description": "监控 CI 失败并找出重复出现的 flake。",
  "scheduled.templates.ci_flakes.prompt": "创建一个每 6 小时运行一次的任务：汇总 CI 失败并找出重复出现的 flake。",
  "scheduled.templates.team_demo_game.description": "为团队 Demo 做一个经典小游戏。",
  "scheduled.templates.team_demo_game.prompt": "创建一个每周一上午 10 点运行的任务：为团队 Demo 做一个经典小游戏。",
  "scheduled.templates.next_skills.description": "推荐这个工作区接下来适合安装的 skills。",
  "scheduled.templates.next_skills.prompt": "创建一个每周三下午 2 点运行的任务：推荐这个工作区接下来适合安装的 skills。",

  // ==================== Settings (Extras) ====================
  "settings.tab.general": "通用",
  "settings.tab.model": "模型",
  "settings.tab.messaging": "消息桥",
